...
class Strapi {
  ...
  logFirstStartupMessage() {
    ...
    console.log(
      chalk.grey('Create your first administrator ðìœŠ» by going to the administration panel at:')
    );
    console.log();
  ...
  logStartupMessage() {
    ...
    if (this.config.serveAdminPanel === true) {
      console.log(chalk.grey('To manage your project ðìœ“€, go to the administration panel at:'));
      const adminUrl = getAbsoluteAdminUrl(strapi.config);
